...
several surface forms ('코리봇' / 'Koribot'), and literal values (dates, numbers)
...
# FACTLOG_ROOT at its own import time, so --wiki has to land in the env first.
...
# dates (2026.4 / 2024-07-01), plain/comma/decimal numbers (2026, 1,000, 3.14),
# and number+unit forms incl. an optional trailing word (1호, 1호 공약, 2026년,
